...
# https://stackoverflow.com/questions/74178121/ruby-imap-accessing-office-365-with-oauth-2-0
  ...
  module IMAP
    class << self
      def check(imap_options={}, options={})
        ...
        imap.authenticate('XOAUTH2',imap_options[:username], imap_options[:access_token])
        imap.select folder
